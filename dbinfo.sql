...
-- 返信用の追加 --
ALTER TABLE inquirys ADD status TINYINT DEFAULT 0 COMMENT '0:未送信 1:返信作業中 2:返信済';
ALTER TABLE inquirys ADD response TEXT COMMENT '返信内容';
ALTER TABLE inquirys ADD response date DATETIME COMMENT '返信日時';
